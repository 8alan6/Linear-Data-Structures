...
public class Controller {
	...
	public Controller(){
		reservationList = new ArrayList<Guest>();
	}
	...
	public void addToReservationList(Guest g){
		reservationList.add(g);
	}
	
	public void displayReservation(RoomList rooms, Guest g, Room r) {
		for(r) {
				System.out.println(guest.getClass().getSimpleName()+" : "+guest.getName()+"\t Room: ");
		}
	}
