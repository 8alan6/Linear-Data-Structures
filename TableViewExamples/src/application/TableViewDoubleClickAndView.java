 ...
 */
public class TableViewDoubleClickAndView extends Application {
	...
	class MyEventHandler implements EventHandler<MouseEvent> {
		...
		public void handle(MouseEvent t) {
			if (t.getClickCount() == 2) {
				...
				alert.setHeaderText("Name = " + recordList.get(index).getName()+" " + recordList.get(index).getLastName());
				alert.setContentText("ID = " + recordList.get(index).getId()+"\nEmail = " + recordList.get(index).getEmail());
